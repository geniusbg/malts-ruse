...
const copy = {
  bg: {
    ...
    pendingPhone: '(очаква се телефон)',
    pendingLink: '(очаква се линк)',
  ...
  en: {
    ...
    instagramLabel: 'Instagram',
    facebookLabel: 'Facebook',
    pendingPhone: '(phone coming soon)',
  ...
  ro: {
    ...
    instagramLabel: 'Instagram',
    facebookLabel: 'Facebook',
    pendingPhone: '(telefon în curând)',
    pendingLink: '(link în curând)',
    workingHoursTitle: 'Program',
    closed: 'Închis',
  ...
  return (
    ...
    <main className="min-h-screen theme-surface text-[var(--theme-ink)] pt-24 md:pt-28 pb-16">
      ...
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-[var(--theme-ink)] text-center mb-12 theme-display">{t.title}</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="mb-6 -mt-4 flex justify-center">
                <Link href={`/${locale}`} className="inline-block max-w-full">
                  <Image
                    ...
                    className="theme-brand-filter h-auto w-full max-w-[min(100%,280px)] object-contain sm:max-w-[320px]"
                  />
                </Link>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--theme-ink)] font-semibold">{t.addressLabel}</p>

                    <p className="theme-muted whitespace-pre-line">{address}</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--theme-ink)] font-semibold">{t.phoneLabel}</p>
                    ...
                    {phone && phoneHref ? (
                      ...
                      <p className="theme-muted">{t.pendingPhone}</p>
                    )}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--theme-ink)] font-semibold">{t.instagramLabel}</p>
                    ...
                    <a
                      ...
                      className="text-[var(--theme-ink)] hover:text-[var(--theme-accent)]"

                    >

                      {instagramUrl ? instagramUrl : t.pendingLink}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--theme-ink)] font-semibold">{t.facebookLabel}</p>
                    ...
                    >
                      ...
                      {facebookUrl ? facebookUrl : t.pendingLink}
            ...
            <div className="theme-card rounded-2xl p-2 overflow-hidden h-full min-h-[280px] shadow-sm">
          ...
          <div className="theme-card rounded-2xl p-8 mt-8 shadow-sm">

            <h3 className="text-2xl font-bold text-[var(--theme-ink)] mb-4">{t.workingHoursTitle}</h3>

            <div className="grid grid-cols-2 md:grid-cols-7 gap-4 text-center">

              {allDays.map((day) => (

                <div key={day.dayOfWeek} className="bg-[var(--theme-inset)] border border-[var(--theme-hairline)] rounded-lg p-3">

                  <p className="theme-muted text-sm mb-1">{t.dayNames[day.dayOfWeek]}</p>

                  {day.isOpen && day.openTime && day.closeTime ? (

                    <p className="text-[var(--theme-ink)] font-semibold text-sm">
                    ...
                    <p className="theme-muted font-semibold">{t.closed}</p>
