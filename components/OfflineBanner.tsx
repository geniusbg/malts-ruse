...
export default function OfflineBanner({ onStatusChange, onBackOnline }: OfflineBannerProps) {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-[var(--theme-paper)]/70 backdrop-blur-sm z-40" />
        ...
        <div className="theme-card max-w-md w-full p-8 text-center">
          ...
          <div className="mb-6">
            {isChecking ? (
              ...
              <div className="inline-flex items-center justify-center w-20 h-20 bg-[var(--theme-accent-tint)] border border-[var(--theme-accent-tint-border)] rounded-full">
                <svg className="h-10 w-10 text-[var(--theme-accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
