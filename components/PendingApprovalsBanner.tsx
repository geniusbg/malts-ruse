  ...
  return (
    <div className={`px-4 md:px-8 pt-2 pb-2 ${className}`}>
      <div className="max-w-7xl mx-auto">
        <ThemeInlineFeedback tone="warning" className="rounded-xl p-4 md:p-6" role="status">
          <div className="flex items-start gap-4">
            <div className="text-2xl md:text-3xl">⚠️</div>
            <div className="flex-1">
              <h3 className="text-lg md:text-xl font-bold text-[var(--theme-ink)] mb-2">
                {locale === 'bg' 
              ...
              <p className="text-sm md:text-base text-[var(--theme-ink)] mb-3">
                {locale === 'bg'
                ...
                <div className="flex gap-2 flex-wrap">
                  {pendingApprovals.map((approval: any) => (
                    <button
                      ...
                      className="px-3 md:px-4 py-2 theme-btn-secondary font-semibold rounded-lg transition-colors text-sm md:text-base"
                    >
                      {locale === 'bg'
